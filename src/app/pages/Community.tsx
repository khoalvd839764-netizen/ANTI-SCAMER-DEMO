      ...
      <div className="flex-1 overflow-y-auto pb-24">
        <div className="p-6">
          ...
          <div className="grid grid-cols-3 gap-3 mb-6">
            <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/20 backdrop-blur-sm border border-blue-400/30 rounded-xl p-3 text-center">
              <div className="text-2xl font-bold text-blue-300 mb-1">2.4k</div>
              <div className="text-[10px] text-gray-400">Thành viên</div>
            </div>
            <div className="bg-gradient-to-br from-green-500/20 to-green-600/20 backdrop-blur-sm border border-green-400/30 rounded-xl p-3 text-center">
              <div className="text-2xl font-bold text-green-300 mb-1">847</div>
              <div className="text-[10px] text-gray-400">Bài đăng</div>
            </div>
            <div className="bg-gradient-to-br from-purple-500/20 to-purple-600/20 backdrop-blur-sm border border-purple-400/30 rounded-xl p-3 text-center">
          ...
          <Button
            ...
            className="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white py-4 rounded-xl font-bold text-base shadow-xl mb-6 transition-all"
          >
          ...
          {/* Post Form */}
          {showPostForm && (
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 mb-6 shadow-lg">
              ...
              <textarea
                ...
                className="w-full bg-white/5 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:border-red-400 focus:outline-none transition-all resize-none"
                rows={4}
              />
              ...
              <div className="flex gap-2 mt-3">
                <Button
                  ...
                  className="flex-1 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white py-2 rounded-lg font-semibold text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Đăng
                </Button>
                <Button
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg font-semibold text-xs whitespace-nowrap transition-all duration-300 ${
                    filter === item.value
                      ...
                      : "bg-white/10 backdrop-blur-sm border border-white/20 text-gray-400"
                  }`}
                >
            ...
            {filteredPosts.length > 0 ? (
              filteredPosts.map((post) => {
                ...
                return (
                  <div
                    key={post.id}
                    className={`bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 shadow-lg hover:bg-white/15 transition-all relative ${
