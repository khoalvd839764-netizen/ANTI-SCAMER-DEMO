...
export function EmergencySupport() {
  ...
  const emergencyOptions = [
    ...
    },
    {
      ...
      action: () => {
        toast.info("Đang kết nối với chuyên gia bảo mật...", {
          description: "Thời gian chờ: ~30 giây",
          duration: 3000,
        });
      },
    },
    ...
    },
    {
      ...
      action: () => {
        navigate("/chat-ai");
        toast.success("Đã chuyển đến phòng chat hỗ trợ", {
          duration: 2000,
        });
      },
    },
  ...
  return (
    <div className="min-h-full px-5 pb-6 pt-10">
      ...
      <div className="mb-5">
        ...
        <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 backdrop-blur-xl rounded-3xl p-5 border-2 border-white/20 shadow-2xl">
      ...
      {/* Info Banner */}
      <div className="mb-5 bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-xl rounded-2xl p-3.5 border border-white/10">
      ...
      <div className="space-y-3 mb-5">
        ...
        {emergencyOptions.map((option) => (
          ...
          >
            ...
            {/* Card */}
            <div className={`relative bg-gradient-to-br ${option.color} bg-opacity-10 backdrop-blur-xl rounded-2xl p-4 border-2 border-white/20 shadow-xl transition-all duration-300 group-hover:border-white/40`}>
              {/* Glass overlay */}
      ...
      {/* Warning Note */}
      <div className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 backdrop-blur-xl rounded-2xl p-3.5 border border-yellow-400/20">
        <div className="flex items-start gap-2.5">
