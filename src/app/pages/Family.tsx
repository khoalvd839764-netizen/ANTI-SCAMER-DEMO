  ...
  return (
    <div className="h-full flex flex-col relative">
      ...
      <div className="flex-1 overflow-y-auto pb-24">
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <div className="bg-gradient-to-br from-blue-500/20 to-purple-600/20 backdrop-blur-sm border-2 border-blue-400/30 rounded-2xl p-4 shadow-xl">
            ...
            <div className="bg-gradient-to-br from-red-500/20 to-orange-600/20 backdrop-blur-sm border-2 border-red-400/30 rounded-2xl p-4 shadow-xl">
          ...
          {activeTab === "members" && (
            <>
              ...
              <Button 
                ...
                className="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white py-4 rounded-xl font-bold shadow-xl mb-6 flex items-center justify-center gap-2"
              >
              ...
              <div className="space-y-3">
                ...
                {members.map((member) => {
                  ...
                  return (
                    <div
                      key={member.id}
                      className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4 shadow-lg hover:bg-white/15 transition-all"
                    >
                ...
                {requests.length > 0 ? (
                  requests.map((request) => (
                    <div
                      ...
                      className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4 shadow-lg hover:bg-white/15 transition-all cursor-pointer"
                    >
              ...
              <form onSubmit={handleAddMember} className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white/10 border border-white/20 rounded-lg px-3 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-blue-400"
                  />
                </div>
      ...
      {showCallModal && callingMember && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 border-2 border-green-400/30 rounded-2xl shadow-2xl w-full max-w-md max-h-[75vh] overflow-y-auto">
            <div className="p-4">
      ...
      {showAlertModal && alertingMember && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 border-2 border-red-400/30 rounded-2xl shadow-2xl w-full max-w-md max-h-[75vh] overflow-y-auto">
            <div className="p-4">
              {/* Header */}
              <div className="text-center mb-4">
      ...
      {showRequestDetailModal && selectedRequest && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 border-2 border-orange-400/30 rounded-2xl shadow-2xl w-full max-w-md max-h-[65vh] overflow-y-auto">
            <div className="p-3">
              {/* Header */}
