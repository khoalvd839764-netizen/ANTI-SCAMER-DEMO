    ...
    <div className="h-full flex flex-col relative">
      ...
      <div className="flex-1 overflow-y-auto pb-24">
        <div className="p-6">
          ...
          {/* Tab Switcher */}
          <div className="flex gap-2 mb-6 bg-white/10 backdrop-blur-sm rounded-xl p-1 border border-white/20">
            <button
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white/10 backdrop-blur-sm border-2 border-white/20 rounded-xl px-4 py-4 text-white placeholder-gray-500 focus:border-red-400 focus:outline-none transition-all"
                />
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                <label
                  ...
                  className="flex flex-col items-center justify-center w-full h-48 bg-white/10 backdrop-blur-sm border-2 border-dashed border-white/30 rounded-2xl cursor-pointer hover:bg-white/15 hover:border-red-400/50 transition-all"
                >
                  {imagePreview ? (
              ...
              {/* Image Info */}
              {selectedImage && (
                <div className="mt-3 bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
          ...
          <Button
            ...
            className="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white py-4 rounded-xl font-bold text-base shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all"
          >
            {isChecking ? (
